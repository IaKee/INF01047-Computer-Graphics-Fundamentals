...
int main()
{
    ...
    glm::vec4 a = o + 5.6f*x + 5.9f*y + 2.8f*z;
    glm::vec4 b = o + 0.2f*x +9.7f*y +9.0f*z;
    glm::vec4 c = o + 1.3f*x +0.5f*y +7.8f*z;

    glm::vec4 p = 0.3f*a + 0.3f*b + 0.4f*c;

    glm::vec4 na = normalize(x + 0.7f * z);
    glm::vec4 nb = normalize(0.8f * x + 0.2f * y + 0.7f * z);
    glm::vec4 nc = normalize(0.8f * x + 0.8f * z);
    ...
    glm::vec3 Kd = glm::vec3(0.4,0.9,1.0); // Refletância difusa
